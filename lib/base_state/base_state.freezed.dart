...
class _$BaseStateTearOff {
  ...
  BaseSuccess<T> success<T>({T? data, Failure? failure}) {
...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? data, Failure? failure) success,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(T? data, Failure? failure)? success,
...
class _$BaseSuccess<T> implements BaseSuccess<T> {
  const _$BaseSuccess({this.data, this.failure});
  ...
  @override
  String toString() {
    return 'BaseState<$T>.success(data: $data, failure: $failure)';
  }
...
abstract class BaseSuccess<T> implements BaseState<T> {
  const factory BaseSuccess({T? data, Failure? failure}) = _$BaseSuccess<T>;
